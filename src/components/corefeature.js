...
const CoreFeature = () => {
  return (
    <section
      className=" bg-corefeaturesec-image bg-no-repeat bg-[cover] bg-center z-[1000] relative mt-14 font-mullish text-white coreFeature"
    >
      <div className="w-11/12 max-w-[1080px] mx-auto relative pt-4">
        ...
        <div className="grid grid-cols-4 gap-[2rem] mt-8">
          ...
          <div>
            <img src="./Images/instant-activation-icon.svg" alt="" />
            <h2 className="font-extrabold my-4 text-lg">
